<template>
  <div class="example-map">
    ...
    <p>
      <a href="https://github.com/matt-e-king/vue-mapp-kit/tree/master/projects/leaflet-example/src/components/SettingUpMap.vue" target="_blank" rel="noopener">Code on Github</a>
    </p>
  </div>
</template>
